...
(function ($) {
    $.fn.imageUploader = function (options) {
        ...
        let createImg = function (src, filename, id) {
            ...
            if (plugin.settings.preloaded.length) {
                ...
                $container.attr("data-name", filename);
        ...
        let setPreview = function ($container, files) {
            ...
            $(files).each(function (i, file) {
                ...
                $uploadedContainer.append(createImg(URL.createObjectURL(file), file.name, dataTransfer.items.length - 1));
            });
